            ...
            <div className='container-root'>
                ...
                <div className="overflow-hidden h-screen grid grid-cols-1 place-items-center">
                    <div className="grid place-items-center h-50dvh">
                        <SpeedDial id='organigrame' ref={refSpeedDial} visible={true} buttonStyle={{display: 'none'}} disabled={false} hideOnClickOutside={false} model={items} radius={(350)} type="circle" rotateAnimation={true} />
                    </div>
                </div>
                <Footer />
            </div>
