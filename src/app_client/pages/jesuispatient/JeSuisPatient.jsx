    ...
    if (window.innerWidth < 1468){
        return (
            <div className='overflow-x-hidden' style={{width: docWidth + 10, height: docHeight}}> 
                                ...
                                <div className='grid grid-cols-1'>
                                    {
                                        data.data.map((d, i) => (
                                            <div className='grid grid-cols-1'>
                                                <p>{d.title}</p>
                                                <p>{d.detail}</p>
                                                <iframe id="ifra" style={{height: '500px', width: '500px'}} src={d.pdf} onload="alert('iframe loaded');" />
                ...
                <Dialog style={{ height: '80vh' }} visible={dialogPdfVisible} onHide={() => setDialogPdfVisible(false)}>
                    {
                        pdfSelected !== null ? (
                            <iframe className='h-[80vh] w-[80vw]' src={pdfSelected} />
                        ) : 
                        (
                            null
                        )
