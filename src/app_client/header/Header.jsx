                ...
                <div className='header grid place-items-center h-[100px]'>
                    ...
                    <Dialog visible={visible} onHide={() => setVisible(false)} >
                        <div id="tbh" className='grid grid-cols-1 place-items-center'>
                            ...
                            <Button id='presentation' className='headerButton py-8' label='Qui sommes nous' onClick={(e) => {handleAnimationPlay(e, '/presentation')}}></Button>
                            <Button id='bureauetconseil' className='headerButton py-8' label='Bureau et conseil d’administration' onClick={(e) => {handleAnimationPlay(e, '/bureauetconseil')}}></Button>
                            <Button id='projetdesante' className='headerButton py-8' label='Nos projets / Missions' onClick={(e) => {handleAnimationPlay(e, '/projetdesante')}}></Button>
                            <Button id='nosactualites' className='headerButton py-8' label='Nos Actualités' onClick={(e) => {handleAnimationPlay(e, '/nosactualites')}}></Button>
                            <Button id='adherer' className='headerButton py-8' label='Comment adhérer' onClick={(e) => {handleAnimationPlay(e, '/adherer')}}></Button>
                            <Button id='contact' className='headerButton py-8' label='Nous Contacter' onClick={(e) => {handleAnimationPlay(e, '/contact')}}></Button>
                        </div>
                    </Dialog>
                </div>
            )  
