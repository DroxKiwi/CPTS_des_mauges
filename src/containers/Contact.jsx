...
function Contact (props) {
    ...
    return (
        <div className='overflow-x-hidden contact' style={{width: docWidth + 10, height: docHeight - props.headerHeight}}>
            ...
            <iframe src="https://www.facebook.com/people/CPTS-des-Mauges" width="80%" height="500px" />
        </div>
    )
}
